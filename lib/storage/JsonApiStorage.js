...
var JsonApiStorage = cls.extend({
  ...
  _getUrl: function(id, query) {
    ...
    if (this._defaultQuery || query || authData) {
      url += '?';
      url += $.param($.extend({}, this._defaultQuery || {}, query || {}, authData && {token: authData.token} || {}));
    }
  ...
  _getData: function(data) {
    if (this._defaultData || data) {
      return JSON.stringify($.extend({}, this._defaultData || {}, data || {}));
    }
