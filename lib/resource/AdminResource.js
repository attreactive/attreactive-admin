...
var AdminResource = cls.extend({
  init: function(id, title, storage, stringifier) {
    ...
    this._properties = [];
    this._actions = [];
    this._creationFormEnabled = true;
  },
  ...
  getCreationFormUrl: function(item) {
    return this.getListingUrl() + 'new';
  },

  isCreationFormEnabled: function() {
    return this._creationFormEnabled;
  },

  enableCreationForm: function() {
    this._creationFormEnabled = true;
  },

  disableCreationForm: function() {
    this._creationFormEnabled = false
  },
